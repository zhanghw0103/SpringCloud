...
public class PaymentService {
    ...
    @HystrixCommand(fallbackMethod ="paymentInfo_TimeoutFB",commandProperties = {
...
//        int i = 10 / 0;
        ...
        return "线程池：  " + Thread.currentThread().getName() + "paymentInfo_Timeout:  " + id + "\t" + "----ok";
    }

    public String paymentInfo_TimeoutFB(Integer id) {
        return "线程池：  " + Thread.currentThread().getName() + "paymentInfo_Timeout:  " + id + "\t" + "系统繁忙";
    }
//==========熔断
    /**
     * 服务熔断 超时、异常、都会触发熔断
